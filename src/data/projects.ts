...
export const projects: Project[] = [
  ...
  },
  {
    ...
    valueStatement:
      "기획에서 개발, 배포까지 이어진 사이클을 경험한 사례입니다. 단, 현재 배포 URL은 재검증이 필요합니다.",
    problem:
    ...
    implementationHighlights: [
      ...
      "배포까지 진행한 경험이 있으나, 현재 공개 URL은 접속 가능 여부를 다시 확인해야 합니다.",
    ],
    troubleshooting: [
      "추천/커뮤니티라는 표현이 과장되지 않도록 구현된 기능과 데이터 구조화 경험 중심으로 설명해야 합니다.",
      "공연 데이터가 어떤 기준으로 정리됐는지, 사용자가 어떤 흐름으로 정보를 탐색하는지 보강 자료가 필요합니다.",
      "배포 URL이 안정적으로 열리지 않으면 라이브 서비스 증빙으로 쓰지 않고 GitHub, 화면 캡처, 시연영상으로 대체해야 합니다.",
    ],
    result: [
      "배포 경험을 보조적으로 설명할 수 있지만, 현재는 웃지마게임보다 낮은 우선순위로 두는 편이 안전합니다.",
      "증빙은 GitHub 링크, 주요 화면 캡처, 시연영상, 기능 명세를 우선 연결하는 것이 좋습니다.",
    ],
    links: {},
    thumbnail: "",
    media: [],
